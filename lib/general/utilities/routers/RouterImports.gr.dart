...
import 'package:base_flutter/customer/screens/wallet_help/WalletHelpImports.dart'
    as _i39;
import 'package:base_flutter/general/models/intro_model.dart' as _i62;
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    LocationAddressRoute.name: (routeData) =>
        _i1.AdaptivePage<_i9.LocationModel>(
            routeData: routeData,
            builder: (data) {
              final args = data.argsAs<LocationAddressRouteArgs>();
              return _i10.LocationAddress(lat: args.lat, lng: args.lng);
            }),
    ...
    ImportantRoute.name: (routeData) => _i1.AdaptivePage<dynamic>(
        ...
        builder: (data) {
          ...
          return _i33.Important(fromWhere: args.fromWhere);
        }),
    ...
    CompanyRegisterCommercialRoute.name: (routeData) =>
        _i1.AdaptivePage<dynamic>(
            ...
            builder: (data) {
              ...
              return _i41.CompanyRegisterCommercial(userId: args.userId);
            }),
...
class SplashRoute extends _i1.PageRouteInfo<SplashRouteArgs> {
  SplashRoute({required _i61.GlobalKey<_i61.NavigatorState> navigatorKey})
      : super(name,
...
class SplashRouteArgs {
  ...
  final _i61.GlobalKey<_i61.NavigatorState> navigatorKey;
}

class LoginRoute extends _i1.PageRouteInfo<LoginRouteArgs> {
  LoginRoute({_i62.IntroModel? introModel})
      : super(name,
...
class LoginRouteArgs {
  ...
  final _i62.IntroModel? introModel;
}

class WelcomePageRoute extends _i1.PageRouteInfo<WelcomePageRouteArgs> {
  WelcomePageRoute({_i62.IntroModel? introModel})
      : super(name,
            path: '/welcome-page',
...
class CustomerWelcomeRoute extends _i1.PageRouteInfo<CustomerWelcomeRouteArgs> {
  CustomerWelcomeRoute({_i62.IntroModel? introModel})
      : super(name,
...
class LocationAddressRoute extends _i1.PageRouteInfo<LocationAddressRouteArgs> {
  LocationAddressRoute({required double lat, required double lng})
      : super(name,
...
class LocationAddressRouteArgs {
  const LocationAddressRouteArgs({required this.lat, required this.lng});
...
class SelectUserRoute extends _i1.PageRouteInfo<SelectUserRouteArgs> {
  SelectUserRoute({_i62.IntroModel? introModel})
      : super(name,
            path: '/select-user',
...
class ImportantRoute extends _i1.PageRouteInfo<ImportantRouteArgs> {
  ImportantRoute({String fromWhere = "login"})
      : super(name,
            path: '/Important', args: ImportantRouteArgs(fromWhere: fromWhere));

  static const String name = 'ImportantRoute';
}

class ImportantRouteArgs {
  const ImportantRouteArgs({this.fromWhere = "login"});
