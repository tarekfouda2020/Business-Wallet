...
class BuildAddComments extends StatelessWidget {
  final CompSpecificAdsData compSpecificAdsData;

  const BuildAddComments({required this.compSpecificAdsData});
          ...
          child: Row(
            children: [
              BlocBuilder<GenericCubit<File?>, GenericState<File?>>(
                bloc: compSpecificAdsData.imageCubit,
                builder: (_, state) {
                  if (state.data == null) {
                    return IconButton(
                      onPressed: compSpecificAdsData.setImage,
              ...
              Expanded(
                child: LabelTextField(
                  hint: "تعليق",
                  controller: compSpecificAdsData.comment,
              ...
              IconButton(
                onPressed: () => compSpecificAdsData.specificAdsComment(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: DefaultButton(
                      ...
                      onTap: () {
                        AutoRouter.of(context).pop();
                        compSpecificAdsData.deleteImage();
                      },
                      borderRadius: BorderRadius.circular(30),
                      color: MyColors.primary,
                      textColor: MyColors.blackOpacity,
