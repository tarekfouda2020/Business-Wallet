...
class BuildPersonalInfo extends StatelessWidget {
  ...
  final CompFilterReconciliationModel compFilterReconciliationModel;

  const BuildPersonalInfo(
      {required this.compAccountReconciliationData,
      required this.compFilterReconciliationModel});
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          MyText(
                            title: compFilterReconciliationModel.userName,
                            size: 10,
                            color: MyColors.grey,
                          ),
                        ],
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          MyText(
                            title: compFilterReconciliationModel.phone,
                            size: 10,
                            color: MyColors.grey,
                          ),
                        ],
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        MyText(
                          title: compFilterReconciliationModel.email,
                          size: 10,
                          color: MyColors.grey,
                        ),
                      ],
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        MyText(
                          title: compFilterReconciliationModel.address,
                          size: 10,
                          color: MyColors.grey,
                        ),
                      ],
