...
part of 'comp_invitation_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CompInvitationModel _$CompInvitationModelFromJson(Map<String, dynamic> json) {
  return CompInvitationModel(
    id: json['id'] as int,
...
Map<String, dynamic> _$CompInvitationModelToJson(
        CompInvitationModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'idSendCard': instance.idSendCard,
      'fk_city': instance.fkCity,
      'fk_intrest': instance.fkIntrest,
